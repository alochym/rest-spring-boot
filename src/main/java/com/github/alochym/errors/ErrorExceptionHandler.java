...
public class ErrorExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<Object> hadnlerServerInternalErrorException(HttpServletRequest req) {

        CustomError serverError = new CustomError();
        serverError.setMessage(HttpStatus.METHOD_NOT_ALLOWED.getReasonPhrase());
        serverError.setStatusCode(HttpStatus.METHOD_NOT_ALLOWED);
        serverError.addError(HttpStatus.METHOD_NOT_ALLOWED.getReasonPhrase());
